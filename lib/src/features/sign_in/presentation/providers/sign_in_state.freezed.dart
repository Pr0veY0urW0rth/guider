...
/// @nodoc
mixin _$SignInState {
  UsernameFormz get username => throw _privateConstructorUsedError;
...
class _$SignInStateImpl implements _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(username: $username, password: $password, formIsValid: $formIsValid, isPasswordObscured: $isPasswordObscured, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, username, password, formIsValid, isPasswordObscured, status);
